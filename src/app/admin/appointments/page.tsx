            ...
            <Table className="min-w-175">
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="hidden md:table-cell min-w-25">
                    Staff
                  </TableHead>
                  <TableHead className="min-w-45">Date & Time</TableHead>
                  <TableHead className="min-w-25">Status</TableHead>
                  <TableHead className="text-right min-w-15">Actions</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                    ...
                    <TableRow key={appointment.id}>
                      ...
                      <TableCell className="whitespace-nowrap">
                        {appointment.user.phone ? (
                          <a
                            href={
                              getWhatsAppLink(appointment.user.phone) || "#"
                            }
                            target="_blank"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  {selectedAppointment.user.phone && (
                    <a
                      href={
                        getWhatsAppLink(selectedAppointment.user.phone) || "#"
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    >
                      ...
                      <span>
                        {formatBDPhone(selectedAppointment.user.phone)}
                      </span>
                    </a>
                  )}
                </div>
