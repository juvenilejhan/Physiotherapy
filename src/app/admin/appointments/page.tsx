            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold">{selectedAppointment.user.name}</p>
                  <p className="text-sm text-muted-foreground">{selectedAppointment.user.email}</p>
                  {selectedAppointment.user.phone && (
                    <p className="text-sm text-muted-foreground">{selectedAppointment.user.phone}</p>
                  )}
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Duration: {selectedAppointment.service.duration} minutes</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Staff</p>
                  <p className="font-semibold">{selectedAppointment.staff?.user.name || 'Unassigned'}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="font-semibold">
                  {format(new Date(selectedAppointment.appointmentDate), 'MMMM dd, yyyy at h:mm a')}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs text-muted-foreground">
                <div>
                  <p>Created: {format(new Date(selectedAppointment.createdAt), 'MMM dd, yyyy h:mm a')}</p>
                </div>
                <div className="text-right">
                  <p>Updated: {format(new Date(selectedAppointment.updatedAt), 'MMM dd, yyyy h:mm a')}</p>
                </div>
              </div>
            </div>
          )}
